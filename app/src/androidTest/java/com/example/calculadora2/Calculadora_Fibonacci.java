...
public class Calculadora_Fibonacci {
    ...
    @Test
    public void calculadora_Fibonacci() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.input_number_edit_text), withText("1"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.input_number_edit_text), withText("12"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.input_number_edit_text), withText("12"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("13"));

        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.input_number_edit_text), withText("13"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText8 = onView(
                allOf(withId(R.id.input_number_edit_text), withText("20"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
